...
class OnboardingFloatingBadge extends StatelessWidget {
  const OnboardingFloatingBadge({super.key, required this.icon, required this.label});
  ...
  Widget build(BuildContext context) {
    ...
    return Container(
      ...
      decoration: BoxDecoration(
        ...
        boxShadow: [
          BoxShadow(color: accent.withAlpha(55), blurRadius: 14, spreadRadius: -2),
      ...
      child: Row(
        ...
        children: [
          ...
          Text(label, style: TextStyle(fontFamily: 'Almarai', fontSize: 13, fontWeight: FontWeight.w700, color: accent)),
        ],
      ),
    );
  }
