...
/// "تغيير كلمة المرور" — reached from the Profile tab. Verifies the current
/// password before accepting a new one; local-only for now (UI ahead of the
/// backend, matching [ProfileScreen]'s other edit flows).
                        ...
                        child: Form(
                          ...
                          child: Column(
                            ...
                            children: [
                              ...
                              ElevatedButton(
                                onPressed: _submit,
                                child: Text(context.t('change_password.save')),
                              ),
                            ],
                          ),
                        ),
