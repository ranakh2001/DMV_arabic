...
/// Fair-strength color has no dedicated slot in [AppColors]; kept as a
/// private constant matching the shade used elsewhere for this state.
const _fairColor = Color(0xFFF57C00);
