      ...
      children: [
        Expanded(
          child: TextButton.icon(
            ...
            label: Text(context.t('exam.previous'), overflow: TextOverflow.ellipsis),
          ),
        ),
        ...
        Expanded(
          child: ElevatedButton.icon(
            ...
            label: Text(context.t('exam.submit'), overflow: TextOverflow.ellipsis),
          ),
        ),
        const SizedBox(width: 8),
        Expanded(
          child: OutlinedButton.icon(
            ...
            label: Text(context.t('exam.next'), overflow: TextOverflow.ellipsis),
          ),
        ),
      ],
    );
