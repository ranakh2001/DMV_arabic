...
/// Bottom action row: Previous / Submit / Next. The physical layout
/// follows the app's text direction: in English, [Previous] is on the
/// left and [Next] on the right; in Arabic (RTL), they swap sides.
