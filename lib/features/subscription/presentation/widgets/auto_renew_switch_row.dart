...
class AutoRenewSwitchRow extends StatelessWidget {
  const AutoRenewSwitchRow({super.key, required this.value, required this.onChanged});
  ...
  Widget build(BuildContext context) {
    return GlassContainer(
      radius: 16,
      padding: EdgeInsets.symmetric(horizontal: context.sp(16), vertical: context.sp(4)),
      child: Row(
